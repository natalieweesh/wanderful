...
i2 = Itinerary.create(description: "a mellow day", time_it_takes: 4, user_id: 2)
i2.activity_ids = [2, 3, 8]
i3 = Itinerary.create(description: "throwback thursday", time_it_takes: 5, user_id: 3)
i3.activity_ids = [1, 3, 9, 10]
i4 = Itinerary.create(description: "foodie tour", time_it_takes: 3, user_id: 4)
i4.activity_ids = [6, 7]
i5 = Itinerary.create(description: "for morning people", time_it_takes: 2, user_id: 5)
i5.activity_ids = [5, 7]
i6 = Itinerary.create(description: "when you're feeling restless", time_it_takes: 5, user_id: 1)
i6.activity_ids = [1, 5, 10]
i7 = Itinerary.create(description: "a cheap night out", time_it_takes: 3, user_id: 2)
i7.activity_ids = [3, 4]
